import "../../css/Tentang-Kami/profilPerusahaan.css";
const ProfilPerus = () => {
  return (
    <div>
      <div className="hero-section-profil"></div>
      <div className="sejarah-sembada">
        <div
          className="sejarah-desc"
          data-aos="fade-left"
          data-aos-offset="500"
        ...
        >
          ...
          <p>
            ...
            <br />
            <br />
            Sejak Januari 2022, Bank diakuisisi oleh PT. Hakim Putra Perkasa,
        ...
        <div
          className="cover-img-sejarah"
          data-aos="zoom-out"
          data-aos-once="true"
        >
          <img src="assets/kantor-sembada.jpg" alt="" c />
        </div>
      </div>
    </div>
  );
};
export default ProfilPerus;
