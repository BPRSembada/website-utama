...
import "../../css/Forms/formsdb.css";
import { API_all, FINAL_API_Sdb } from "../../database/APIs";
...
const FormSDB = () => {
  ...
  const ajukanSdb = () => {
    ...
    if (
      ...
      Axios.post(`${API_all}/SDB`, Datas).then((res) => {
  ...
  return (
    <div>
      <div className="hero-img-formsdb"></div>
      <form className="cont-form-simpanan">
        ...
        <div className="cont-btn-form">
          <Button variant="danger" className="BukaTabungan" onClick={ajukanSdb}>
            Daftar SDB
          </Button>{" "}
          <p>
            Dengan klik 'Daftar SDB' maka petugas bank Sembada dapat segera
            melayani Anda untuk proses pengajuan layanan Safe Deposit Box.
          </p>
        </div>
      </form>
