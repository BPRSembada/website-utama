...
import "../../css/Forms/formSimpanan.css";
...
import { API_Simpanan_dummy, API_all } from "../../database/APIs";
...
const FormSimpanan = () => {
  ...
  return (
    <div>
      <div className="hero-section-formSimpanan"></div>
      <form className="cont-form-simpanan">
        <div className="cont-formss">
          <h3>Form pengajuan simpanan atau deposito :</h3>
