...
const KalkulatorKredit = () => {
        ...
        <div className="hasil-kalkulator">
          ...
          <Table striped bordered hover>
            <thead>
              <tr>
                <th colSpan={2}>
                  Tenor pinjaman {tenor[1]} dengan bunga {bunga[1]}
                </th>
              </tr>
            </thead>
            <tbody>
              ...
              <tr>
                <td>Total bunga</td>
                <td>Rp. {Math.round(hasil[0]).toLocaleString()}</td>
              </tr>
              <tr>
                <td>Angsuran per bulan</td>
                <td>Rp. {Math.round(hasil[2]).toLocaleString()}</td>
              </tr>
              <tr>
                <td>Total angsuran</td>
                <td>Rp. {Math.round(hasil[1]).toLocaleString()}</td>
              </tr>
            </tbody>
          </Table>
        ...
        <div className="hasil-kalkulator">
          ...
          <Table striped bordered hover>
            <thead>
              <tr>
                <th colSpan={2}>
                  Tenor Pinjaman {tenor[1]} dengan bunga {bungaPRK[1]}
                </th>
              </tr>
            </thead>
            <tbody>
              ...
              <tr>
                <td>Bunga harian</td>
                <td>Rp. {Math.round(hasilPRK[0]).toLocaleString()}</td>
              </tr>

              <tr>
                <td>Angsuran bunga per bulan</td>
                <td>Rp. {Math.round(hasilPRK[1]).toLocaleString()}</td>
              </tr>
            </tbody>
          </Table>
  ...
  const kalkulasi = () => {
    let TotalBunga = +(nominal * bunga[0]);
  ...
  const kalkulasiPRK = () => {
    let TotalBunga = +(nominal * bungaPRK[0]);
  ...
  return (
    <div className="main-kalkulator">
      ...
      <div className="calkulator-pinjaman-page">
        <p>
          Kalkulator ini dirancang sebagai simulasi pinjaman menggunakan suku
          bunga 14% p.a. dengan nilai pendekatan, suku bunga dapat berubah
          sesuai dengan ketetapan Bank, untuk mendapatkan informasi lebih lanjut
          silahkan hubungi petugas bank kami
        </p>
      </div>
    </div>
  );
